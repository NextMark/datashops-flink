...
import com.bigdata.datashops.processor.sqlsubmit.cli.CliOptions;
import com.bigdata.datashops.processor.sqlsubmit.cli.CliOptionsParser;
    ...
    private void run() throws Exception {
        ...
        if (calls.size() == 0) {
            throw new RuntimeException(
                    "There is no sql statement to execute,please check your sql file: " + sqlFilePath);
        }
